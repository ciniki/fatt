...
// Description
// -----------
// This method will add a new aed for the tenant.
//
// Arguments
// ---------
// api_key:
// auth_token:
// tnid:        The ID of the tenant to add the AED to.
//
// Returns
// -------
// <rsp stat="ok" id="42">
...
function ciniki_fatt_aedAdd(&$ciniki) {
    ...
    $rc = ciniki_fatt_checkAccess($ciniki, $args['tnid'], 'ciniki.fatt.aedAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.fatt.aed', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
