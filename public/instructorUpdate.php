...
function ciniki_fatt_instructorUpdate(&$ciniki) {
    ...
    $rc = ciniki_fatt_checkAccess($ciniki, $args['tnid'], 'ciniki.fatt.instructorUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.fatt.instructor', $args['instructor_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
