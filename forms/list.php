...
//            ),
        'CA-ON-LSS-BFA'=>array('id'=>'CA-ON-LSS-BFA', 'name'=>'Ontario LSS - BFA', 
            'processor'=>'CAONLSSBFA', 
            'options'=>array('recert'=>''),
            ),
        'CA-ON-LSS-IFA'=>array('id'=>'CA-ON-LSS-IFA', 'name'=>'Ontario LSS - IFA - CPR/AED', 
            'processor'=>'CAONLSSIFA', 
            'options'=>array('recert'=>''),
            ),
        'CA-ON-LSS-HCP-2026'=>array('id'=>'CA-ON-LSS-HCP-2026', 'name'=>'Ontario LSS - HCP 2026', 
            'processor'=>'CAONLSSHCP2026', 
            'options'=>array('recert'=>''),
            ),
        'CA-ON-LSS-HCP-R-2026'=>array('id'=>'CA-ON-LSS-HCP-R-2026', 'name'=>'Ontario LSS - HCP 2026 - Renewal', 
            'processor'=>'CAONLSSHCP2026', 
