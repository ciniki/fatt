...
// Description
// -----------
// This method will add a new aed image for the business.
//
// Arguments
// ---------
// api_key:
// auth_token:
// business_id:        The ID of the business to add the AED Image to.
//
// Returns
// -------
// <rsp stat="ok" id="42">
...
function ciniki_fatt_aedImageAdd(&$ciniki) {
    ...
    $rc = ciniki_fatt_checkAccess($ciniki, $args['business_id'], 'ciniki.fatt.aedImageAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    ciniki_core_hookExec($ciniki, $args['business_id'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.fatt.aedImage', 'object_id'=>$aedimage_id));
