...
// Description
// -----------
// This method will add a new instructor for the tenant.
//
// Arguments
// ---------
// api_key:
// auth_token:
// tnid:     The ID of the tenant to add the instructor to.
//
// Returns
// -------
// <rsp stat="ok" id="42">
...
function ciniki_fatt_instructorAdd(&$ciniki) {
    ...
    $rc = ciniki_fatt_checkAccess($ciniki, $args['tnid'], 'ciniki.fatt.instructorAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.fatt.instructor', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
