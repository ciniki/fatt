...
function ciniki_fatt_courseUpdate(&$ciniki) {
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
		...
		'num_days'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Number of Days'), 
	...
	if( isset($args['name']) ) {
		...
		if( $rc['num_rows'] > 0 ) {
			return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'2315', 'msg'=>'You already have a course with this name, please choose another name'));
		}
	}
