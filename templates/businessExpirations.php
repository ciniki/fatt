...
// <rsp stat='ok' id='34' />
//
function ciniki_fatt_templates_businessExpirations(&$ciniki, $business_id, $args) {
...
/*			if( count($this->header_details) <= 6 ) {
	...
	if( !isset($args['sapos_settings']['invoice-header-contact-position'])
		...
		if( !isset($args['sapos_settings']['invoice-header-business-name'])
			|| $args['sapos_settings']['invoice-header-business-name'] == 'yes' ) {
			$pdf->header_name = $args['business_details']['name'];
			$pdf->header_height = 8;
		}
		if( !isset($args['sapos_settings']['invoice-header-business-address'])
			|| $args['sapos_settings']['invoice-header-business-address'] == 'yes' ) {
			if( isset($args['business_details']['contact.address.street1']) 
				&& $args['business_details']['contact.address.street1'] != '' ) {
				$pdf->header_addr[] = $args['business_details']['contact.address.street1'];
			}
			if( isset($args['business_details']['contact.address.street2']) 
				&& $args['business_details']['contact.address.street2'] != '' ) {
				$pdf->header_addr[] = $args['business_details']['contact.address.street2'];
			}
			$city = '';
			if( isset($args['business_details']['contact.address.city']) 
				&& $args['business_details']['contact.address.city'] != '' ) {
				$city .= $args['business_details']['contact.address.city'];
			}
			if( isset($args['business_details']['contact.address.province']) 
				&& $args['business_details']['contact.address.province'] != '' ) {
				$city .= ($city!='')?', ':'';
				$city .= $args['business_details']['contact.address.province'];
			}
			if( isset($args['business_details']['contact.address.postal']) 
				&& $args['business_details']['contact.address.postal'] != '' ) {
				$city .= ($city!='')?'  ':'';
				$city .= $args['business_details']['contact.address.postal'];
			}
			if( $city != '' ) {
				$pdf->header_addr[] = $city;
			}
		}
		if( !isset($args['sapos_settings']['invoice-header-business-phone'])
			|| $args['sapos_settings']['invoice-header-business-phone'] == 'yes' ) {
			if( isset($args['business_details']['contact.phone.number']) 
				&& $args['business_details']['contact.phone.number'] != '' ) {
				$pdf->header_addr[] = 'phone: ' . $args['business_details']['contact.phone.number'];
			}
			if( isset($args['business_details']['contact.tollfree.number']) 
				&& $args['business_details']['contact.tollfree.number'] != '' ) {
				$pdf->header_addr[] = 'phone: ' . $args['business_details']['contact.tollfree.number'];
			}
		}
		if( !isset($args['sapos_settings']['invoice-header-business-cell'])
			|| $args['sapos_settings']['invoice-header-business-cell'] == 'yes' ) {
			if( isset($args['business_details']['contact.cell.number']) 
				&& $args['business_details']['contact.cell.number'] != '' ) {
				$pdf->header_addr[] = 'cell: ' . $args['business_details']['contact.cell.number'];
			}
		}
		if( (!isset($args['sapos_settings']['invoice-header-business-fax'])
			|| $args['sapos_settings']['invoice-header-business-fax'] == 'yes')
			&& isset($args['business_details']['contact.fax.number']) 
			&& $args['business_details']['contact.fax.number'] != '' ) {
			$pdf->header_addr[] = 'fax: ' . $args['business_details']['contact.fax.number'];
		}
		if( (!isset($args['sapos_settings']['invoice-header-business-email'])
			|| $args['sapos_settings']['invoice-header-business-email'] == 'yes')
			&& isset($args['business_details']['contact.email.address']) 
			&& $args['business_details']['contact.email.address'] != '' ) {
			$pdf->header_addr[] = $args['business_details']['contact.email.address'];
		}
		if( (!isset($args['sapos_settings']['invoice-header-business-website'])
			|| $args['sapos_settings']['invoice-header-business-website'] == 'yes')
			&& isset($args['business_details']['contact-website-url']) 
			&& $args['business_details']['contact-website-url'] != '' ) {
			$pdf->header_addr[] = $args['business_details']['contact-website-url'];
		}
	}
	...
	$pdf->business_details = $args['business_details'];
...
/*	$pdf->header_details = array(
	...
	$pdf->SetAuthor($args['business_details']['name']);
