...
// -------
//
function ciniki_fatt_classLoad($ciniki, $tnid, $args) {
    //
    ...
    $rc = ciniki_core_dbHashQueryTree($ciniki, $strsql, 'ciniki.fatt', array(
        ...
        array('container'=>'offerings', 'fname'=>'id', 'name'=>'offering', 
            'fields'=>array('id', 'course_code'=>'course_codes', 'course_hours', 'course_name', 'course_id', 'cert_form1', 'cert_form2', 'max_seats', 'seats_remaining')),
        ));
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
