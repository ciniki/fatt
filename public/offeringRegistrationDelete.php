...
function ciniki_fatt_offeringRegistrationDelete(&$ciniki) {
	...
	$rc = ciniki_fatt_checkAccess($ciniki, $args['business_id'], 'ciniki.fatt.offeringRegistrationDelete');
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	...
	//
	$rc = ciniki_core_objectDelete($ciniki, $args['business_id'], 'ciniki.fatt.offeringregistration', 
